    ...
    <main className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
      <div className="mb-8 border-b border-slate-200 pb-8">
        ...
        <p className="mt-3 max-w-3xl text-base leading-7 text-slate-600">
          Search and triage feedback while Gemini classification stores sentiment and theme
          assignments. Day 13 adds a dedicated theme-cluster view so every assigned theme can be
          explored back to the tenant-scoped feedback that supports it inside {user.workspace.name}.
        </p>
      </div>
