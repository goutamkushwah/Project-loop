  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
      <div className="rounded-3xl border border-red-200 bg-red-50 p-8 text-center">
        ...
        <h1 className="mt-5 text-2xl font-black text-red-950">Theme trends could not be loaded</h1>
        <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-red-800">
          LOOP could not calculate the workspace trend comparison. No feedback, themes, or assignments were changed.
        </p>
        <button
          type="button"
          onClick={reset}
