      ...
      <div className="flex flex-col gap-5 border-b border-slate-200 pb-8 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-loop-600">
            AI integration · Day 14
          </p>
          <h1 className="mt-3 text-4xl font-black tracking-tight text-loop-900">Theme trends</h1>
          <p className="mt-3 max-w-3xl text-base leading-7 text-slate-600">
            Track how customer-feedback themes change over time in the isolated{" "}
            {user.workspace.name} workspace and compare the selected period with the immediately
